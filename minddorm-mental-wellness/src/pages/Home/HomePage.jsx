...
//       {/* Header Section */}
//       <header className="container mx-auto px-4 py-10 md:py-12 flex flex-col md:flex-row items-center justify-between mb-0">
//         {/* Left: Text */}
...
//           </h1>
//           <p className="text-lg text-slate-600 mb-6">“For every student who feels overwhelmed.”</p>
//           <div className="flex flex-col sm:flex-row gap-4 mb-4">
//             <button className="bg-[#F4F8FB] text-[#000459] px-6 py-2 rounded-full font-semibold border border-[#D6E6F2] hover:bg-blue-100 transition shadow-none">
//               Start Your Journey
//             </button>
//             <button className="bg-[#F4F8FB] text-[#000459] px-6 py-2 rounded-full font-semibold border border-[#D6E6F2] hover:bg-blue-100 transition shadow-none">
//               Join our community
...
//             <span className="text-slate-500 text-base font-medium">“Feeling overwhelmed?</span>
//             <span className="text-slate-500 text-base font-medium">Try this 2-min calm track.”</span>
//           </div>
//           <div className="flex items-center gap-2 mb-4">
//             {/* Play button */}
//             <button className="relative w-8 h-8 flex items-center justify-center rounded-full bg-[#F4F8FB] border border-[#D6E6F2] hover:bg-blue-100 transition group overflow-hidden">
//               <svg
...
//               </svg>
//               <span className="absolute inset-0 rounded-full animate-ping bg-blue-200 opacity-60 group-hover:opacity-80"></span>
//             </button>
//             {/* Animated music lines - black */}
...
//             </span>
//           </div>
//           <div className="inline-block bg-[#F4F8FB] border border-[#D6E6F2] px-4 py-2 rounded-full text-sm text-[#000459] font-medium shadow-none">
//             chat with AI
//           </div>
//         </div>
//         {/* Right: Hero Image */}
//         <div className="md:w-1/2 mt-8 md:mt-0 flex justify-center md:justify-end pr-20">
//           {/* Placeholder for hero illustration */}
//           <img src="/hero_img.png" alt="Emotional Support" className="w-40 md:w-40" />
//         </div>
//       </header>

//       {/* Services Section */}
//       <section className="container mx-auto px-4 mb-0 z-10 relative">
//         <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap- max-w-5xl mx-auto">
//           <div className="bg-[#F4F8FB] border border-[#D6E6F2] p-6 rounded-2xl shadow-none">
//             <h3 className="text-xl font-bold mb-2 text-[#2B3990] tracking-wide">SESSION BOOKING</h3>
//             <p className="text-base text-slate-600">“Talk to someone who gets it”<br />Gentle, inviting, and student-friendly—perfect for encouraging help-seeking without pressure.</p>
//           </div>
//           <div className="bg-[#F4F8FB] border border-[#D6E6F2] p-6 rounded-2xl shadow-none">
//             <h3 className="text-xl font-bold mb-2 text-[#2B3990] tracking-wide">SELF TESTS</h3>
//             <p className="text-base text-slate-600">“Check in with yourself”<br />Quick, science-backed mental health assessments designed for students to better understand their emotional state</p>
//           </div>
//           <div className="bg-[#F4F8FB] border border-[#D6E6F2] p-6 rounded-2xl shadow-none">
//             <h3 className="text-xl font-bold mb-2 text-[#2B3990] tracking-wide">RESOURCE LIBRARY</h3>
//             <p className="text-base text-slate-600">“Explore what helps”<br />Articles, playlists, notes, and real stories to support your mind, your way</p>
//           </div>
//         </div>
//       </section>

//       {/* Bottom Half Background starts from half of services section */}
//       <div className="relative mt-[-96px] pt-[140px]"> {/* Increased pt for more space above feelings */}
//         <div className="absolute inset-0 bg-[#47708F] z-0"></div>
//         <div className="relative z-10">
//           {/* Feelings Section */}
//           <section className="container mx-auto px-4 mb-16 pt-4"> {/* mb-16 for more space below */}
//             <div className="flex flex-col items-center mb-14"> {/* mb-14 for more space below heading */}
//               <img src="/assets/feelings-hero.png" alt="" className="w-14 mb-4" /> {/* mb-4 for more space below image */}
//               <h2 className="text-2xl font-semibold text-white drop-shadow text-center mb-8">
...
//                   Try a 2 min breathing track or book a calming session
//                 </div>
//               </div>
...
//                 <div className="text-xs text-slate-700 mt-1 text-center">
//                   Chat with AI or take a self-test to check in
//                 </div>
//               </div>
...
//                 <div className="text-xs text-slate-700 mt-1 text-center">
//                   Join student community space or read shared stories
//                 </div>
//               </div>
...
//                 <div className="text-xs text-slate-700 mt-1 text-center">
//                   Book a session with a college counselor
//                 </div>
//               </div>
...
//                 <div className="text-xs text-slate-700 mt-1 text-center">
//                   Explore grounding playlists or journalism prompts
//                 </div>
//               </div>
...
//                 <div className="text-xs text-slate-700 mt-1 text-center">
//                   Browse the resource library for recovery tips
//                 </div>
//               </div>
//             </div>
//           </section>
...
const HomePage = () => {
  return (
    <div className="min-h-screen font-sans bg-gradient-to-b from-[#B5D8EB] to-[#F4F8FB]">
        ...
        <div className="md:w-1/2 text-left">
          ...
          <div className="mb-4">
            ...
            <div className="flex items-center gap-2">
              {/* Play Button */}
              <button className="relative w-8 h-8 flex items-center justify-center rounded-full bg-[#F4F8FB] border border-[#D6E6F2] hover:bg-blue-100 transition group overflow-hidden">
                <svg className="w-4 h-4 text-blue-600 z-10 relative group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 20 20">
                  <polygon points="5,3 16,10 5,17" />
                </svg>
      ...
      {/* Feelings Section with Dark Background */}
